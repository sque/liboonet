...
namespace oonet
{
	...
	bool test_netserver::TestStart::OnExecute()
	{	EchoServer mEchoServer;
	...
	bool test_netserver::TestDoubleStart::OnExecute()
	{	EchoServer mEchoServer;
	...
	bool test_netserver::TestStartRecovery::OnExecute()
	{	EchoServer mEchoServer;
	...
	bool test_netserver::TestStop::OnExecute()
	{	EchoServer mEchoServer;
	...
	bool test_netserver::TestStopWrong1::OnExecute()
	{	EchoServer mEchoServer;
	...
	bool test_netserver::TestStopWrong2::OnExecute()
	{	EchoServer mEchoServer;
	...
	{	EchoServer mEchoServer;
		...
		if (! mEchoServer.get_clients().front()->connected())
			return false;
